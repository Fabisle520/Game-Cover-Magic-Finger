...
HD_PWD='E:/summer_homework/Lab_10/Lab_10.runs/game_R_Rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log game_R_Rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source game_R_Rom.tcl
