...
HD_PWD='E:/summer_homework/Lab_10/Lab_10.runs/over_R_Rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log over_R_Rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source over_R_Rom.tcl
